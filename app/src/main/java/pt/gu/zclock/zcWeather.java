...
public class zcWeather{
    ...
    public zcWeather(Context context, double latitude, double longitude){
    ...
    public zcWeather(Context context){
        ...
        this.latitude = sharedPreferences.getFloat("latitude",0f);
        this.longitude = sharedPreferences.getFloat("longitude",0f);
        JSONForecastTask task = new JSONForecastTask();
        task.execute();
    }

    public zcWeather(Context context, GeoLocation geoLocation){
        this.mContext = context;
        weatherData = new ArrayList<>();
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(mContext);
        this.latitude = (float)geoLocation.getLatitude();
        this.longitude = (float)geoLocation.getLongitude();
        //JSONForecastTask task = new JSONForecastTask();
        //task.execute();
    }
    ...
    public boolean updateForecast(){
        ...
        this.latitude = sharedPreferences.getFloat("latitude",0f);
        this.longitude = sharedPreferences.getFloat("longitude",0f);
        return updateForecast(this.latitude,this.longitude);
    }
    ...
    private void JSONParseForecast(String data) throws JSONException, NullPointerException{
